...
public class Animal
{
    ...
    {
        return String.format("%s, a %s-colored animal. %.1f pounds, %.1f inches%n",
    ...
    public boolean equals(Object other)
    {
        ...
        if(this.color == otherAni.getColor() && this.name == otherAni.getName() && this.weight == otherAni.getWeight() && this.height == otherAni.getHeight())
        {
        	return true;
        }
        return false;
